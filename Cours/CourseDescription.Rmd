...
## Module 4 (9/3): Risque de modélisation. [@Boyle2012; ]

Identification du "risque de modélisation" dans le cadre du modèle moyenne/variance. 

- Risque lié à l'estimation des paramètres
- Risque lié à la formulation même du modèle

On passera en revue les méthodes d'estimation robustes et quelques formulations alternatives du couple rendement/risque.

TP-4 (version 1):

- Mettre en oeuvre le modèle de Kono et Yamazaki
...
Le modèle de Black-Litterman et ses nombreuses extensions est très prisé des gestionnaires du fait de sa flexibilité. Il permet également de limiter les risques de modélisation identifiés précédement.
