...
## Modèle de Markowitz - Solution Analytique
...
## Ajout d'un actif sans risque (2)
...
## Multiple assets - Mean/Variance Optimization
...
## Mean/Variance Optimization Workflow

* Compute expected return and covariance matrix
* Define additional linear constraints
* Set up QP problem and solve
* Vary $r^*$ to draw efficient frontier and tangent portfolio
* Choose allocation mix as a function of risk tolerance


## Mean/Variance Optimization - with Basic R (1)
...
## Portefeuille Tangent (long) - Solution Numérique
